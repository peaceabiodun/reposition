...
const SizeChart = () => {
  ...
  return (
    <div className='w-full h-full min-h-[100vh] bg-[#e4e2df]'>
        ...
        <div className='max-w-[1000px] mx-auto'>
          ...
          <div className='p-4 text-sm space-y-2 w-full '>
            <div className=''>
              ...
              <p>
                With elbow bent, measure from the center (back) of neck to the
                elbow and down to wrist.
              </p>
            </div>
            <div className=''>
            ...
            <div className=''>
              ...
              <p>
                Bend Slightlt to one side of your natural waist. (This will be
                the crease created from bending.) Then, stand erect and measure
                around your body at the crease point.
              </p>
            </div>
            ...
            <div className=''>
              ...
              <p>
                Stand relaxed with feet shoulder-wide apart. now measure around
                the fullest part of your hips and seat.
              </p>
            </div>
          </div>
          ...
          <div className='p-4 w-full flex flex-col items-center justify-center'>
            ...
            <table className='w-full '>
              <tr className='border-y border-[#a1a1a19c] bg-[#38271c] text-[#ecf3f3] '>
